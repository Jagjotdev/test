...
echo"
   ...
   <center> <b>
<h4 style='font-weight: 600; font-size: 1rem; color:blue; border: solid red 3px; border-radius: 5px; padding-top:6px; padding-bottom:6px; width:80%;' >$cname Campaign <br>[ Refer- ₹$ramo || User- ₹$uamo ]</h4></b><br><b>
<h4 style='font-weight: 600; font-size: 1.2rem; color:blue; padding-top:3px; padding-bottom:3px; width:70%;'' >REFER & EARN</h4></b><br><br><form action='' method='POST'>
      
    
          <div class='control'>
<i class='material-icons md-36' id='i'></i>
          <input  type='number' class='input' placeholder='Enter Paytm Number' name='number' required maxlength='10' oninput='javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);' autocomplete='off' value='$ptm'></div>
       <input type='hidden' name='offer' value='$of'>
...
</html><?php }else{echo "<meta http-equiv='refresh' content='0 url=https://$domain'>";}?>