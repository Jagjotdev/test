...
<span class="login100-form-title p-b-25" style="font-size:25px !important; font-family: "Corben", cursive;">
        <center>
     <h4 style="font-weight: 600; font-size: 1.2rem; color:blue;  padding-top:3px; padding-bottom:3px; width:70%;" >
     <?php

$dfile="admin/user/data.json";
if(file_exists($dfile)){
    echo'<center>DATA EDITED<br><br>Redirecting to Home...</center><meta http-equiv="refresh" content="3 url=admin.php">';
}else{
        echo'<center>DATA ADDED<br><br>Redirecting to Home...</center><meta http-equiv="refresh" content="1 url=admin.php">';
}
$cname=$_GET['name'];
$clogo=$_GET['logo'];
$ctig=$_GET['tig'];
$a11="@";
$a12="https://t.me/";
$p1=str_replace($a11,"",$ctig);
$tig=str_replace($a12,"",$p1);
$tiig=str_replace(" ","",$tig);

$in='{"name":"'.$cname.'","logo":"'.$clogo.'","tig":"'.$tiig.'"}';
file_put_contents("$dfile",$in)
?></h4>   
    </center>
</span>
